...
# Configuration
TOKEN = "7207937052:AAHSu46r26TH1GLD4VZERV1U_XpheDPdNMo"  # Replace with your Telegram bot token
ADMIN_IDS = {7336084070}  # Replace with your actual admin user ID(s)

# MongoDB setup
mongo_client = pymongo.MongoClient("mongodb+srv://Sam:bgmiop111@sam.4nw7s.mongodb.net/?retryWrites=true&w=majority&appName=Sam")
